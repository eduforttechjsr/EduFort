// EduFort Technologies - Multi-page Animated Website
// Pages: Home, About, Vision & Mission, Our Promise, Pricing, Testimonials, Team, Contact Us
// Tech: React + Tailwind CSS + Framer Motion + Lottie + Formspree

import React from 'react';
import { BrowserRouter as Router, Routes, Route, Link } from 'react-router-dom';
import { motion } from 'framer-motion';
import Lottie from 'lottie-react';
import schoolAnimation from './src/lottie/smart-school.json';
...
const About = () => <div className="p-10 text-center text-xl">About Us Page</div>;
const Vision = () => <div className="p-10 text-center text-xl">Vision & Mission Page</div>;
const Promise = () => <div className="p-10 text-center text-xl">Our Promise Page</div>;
const Pricing = () => <div className="p-10 text-center text-xl">Pricing Page</div>;
const Testimonials = () => <div className="p-10 text-center text-xl">Testimonials Page</div>;
const Team = () => <div className="p-10 text-center text-xl">Team Page</div>;
const Contact = () => <div className="p-10 text-center text-xl">Contact Page</div>;
